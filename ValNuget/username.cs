...
namespace ValAPINet
{
    public class Username
    {
        ...
        public static Username GetUsername(AuthorizationHandler au, string playerid = null)
        {
...
public static List<Username> GetUsername(AuthorizationHandler au, List<string> playerids)
        {
            string url = "https://pd." + au.Region + ".a.pvp.net/name-service/v2/players";
            RestClient client = new RestClient(url);
            client.CookieContainer = au.Cookies;
